...
To find out which packages are really installed into _flir-image-sherlock_ (and thus replaceable), generate your own package database using information as described by: [package management addition to rootfs](package-management-addition.md).<br>
